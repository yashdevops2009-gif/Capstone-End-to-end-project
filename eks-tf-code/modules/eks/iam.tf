...
# Attach necessary policies to Node Group IAM role
...
resource "aws_iam_role" "yash_ebs_csi" {
  assume_role_policy = data.aws_iam_policy_document.ebs_csi_assume_role_policy.json
  name               = "AmazonEKS_EBS_yash_CSI_DriverRole"
}

resource "aws_iam_role_policy_attachment" "yash_ebs_csi" {
  policy_arn = "arn:aws:iam::aws:policy/service-role/AmazonEBSCSIDriverPolicy"
  role       = aws_iam_role.yash_ebs_csi.name
}
